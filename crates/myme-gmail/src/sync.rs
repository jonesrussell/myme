...
mod tests {
    ...
    fn test_fifo_order() {
        ...
        assert!(matches!(first.action, SyncAction::MarkRead { message_id } if message_id == "msg1"));
    }
    ...
    fn test_action_serialization() {
        ...
        let actions = vec![
            ...
            SyncAction::AddLabels { message_id: "m7".to_string(), labels: vec!["Label1".to_string()] },
            SyncAction::RemoveLabels { message_id: "m8".to_string(), labels: vec!["Label2".to_string()] },
        ];
